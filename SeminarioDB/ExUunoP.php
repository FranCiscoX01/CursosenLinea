...
<?php
        ...
        $preguntas1 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=31");
        $respuestas1 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=31 ORDER BY RAND()");
        
        $preguntas2 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=32");
        $respuestas2 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=32 ORDER BY RAND()");

        $preguntas3 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=33");
        $respuestas3 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=33 ORDER BY RAND()");

        $preguntas4 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=34");
        $respuestas4 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=34 ORDER BY RAND()");

        $preguntas5 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=35");
        $respuestas5 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=35 ORDER BY RAND()");

        $preguntas6 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=36");
        $respuestas6 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=36 ORDER BY RAND()");

        $preguntas7 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=37");
        $respuestas7 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=37 ORDER BY RAND()");

        $preguntas8 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=38");
        $respuestas8 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=38 ORDER BY RAND()");

        $preguntas9 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=39");
        $respuestas9 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=39 ORDER BY RAND()");

        $preguntas10 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=1 AND idPregunta=40");
        $respuestas10 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=1 AND idPregunta=40 ORDER BY RAND()");
...
?>
    ...
    <div class="container">
        <form action="CalifEPuno.php" method="POST">
            <p></p>
            <?php
