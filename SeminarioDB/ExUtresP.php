...
<?php
        ...
        $preguntas21 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=51");
        $respuestas21 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=51 ORDER BY RAND()");
        
        $preguntas22 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=52");
        $respuestas22 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=52 ORDER BY RAND()");

        $preguntas23 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=53");
        $respuestas23 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=53 ORDER BY RAND()");

        $preguntas24 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=54");
        $respuestas24 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=54 ORDER BY RAND()");

        $preguntas25 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=55");
        $respuestas25 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=55 ORDER BY RAND()");

        $preguntas26 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=56");
        $respuestas26 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=56 ORDER BY RAND()");

        $preguntas27 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=57");
        $respuestas27 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=57 ORDER BY RAND()");

        $preguntas28 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=58");
        $respuestas28 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=58 ORDER BY RAND()");

        $preguntas29 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=59");
        $respuestas29 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=59 ORDER BY RAND()");

        $preguntas30 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=2 AND Unidad=3 AND idPregunta=60");
        $respuestas30 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=2 AND Unidad=3 AND idPregunta=60 ORDER BY RAND()");
...
?>
    ...
    <div class="container">
        <form action="CalifEPtres.php" method="POST">
            <p></p>
            <?php
