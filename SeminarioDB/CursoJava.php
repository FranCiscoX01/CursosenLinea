...
<body>
    <?php
        ...
        $check = mysqli_query($conexion, "SELECT * FROM RegistroActCurso WHERE 	idCurso=1 AND Username='".$_SESSION['usuario']."'");
    ?>
        ...
        <form method="POST" action="TemarioGeneral.php">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row">1</th>
                        <td>La tecnología Java</td>
                        <td></td>
                    </tr>
                    <tr>
                        <th scope="row">1.1</th>
                        <td>El lenguaje de programación Java</td>
                        <td>
                            <?php
                                    if($checked['Act1'] == "x"){
                    ...
                    <tr>
                        <th scope="row">1.3</th>
                        <td>Tipos de programas en Java</td>
                        <td>
                            <?php
                                    if($checked['Act3'] == "x"){
                    ...
                    <tr>
                        <th scope="row">1.4</th>
                        <td>Compilación y ejecución de programas</td>
                        <td>
                            <?php
                                    if($checked['Act4'] == "x"){
                    ...
                    <tr>
                        <th scope="row">1.5</th>
                        <td>Creación de aplicaciones con el JDK</td>
                        <td>
                            <?php
                                    if($checked['Act5'] == "x"){
                    ...
                    <tr>
                        <th scope="row">2.5</th>
                        <td>Expresiones y Operadores</td>
                        <td>
                            <?php
                                    if($checked['Act10'] == "x"){
                    ...
                    <tr>
                        <th scope="row">3</th>
                        <td>Conceptos de la Programación Orientada a Objetos</td>
                        <td></td>
                    </tr>
                    <tr>
                        <th scope="row">3.1</th>
                    ...
                    <tr>
                        <th scope="row">3.4</th>
                        <td>Herencia, Superclases y Subclases</td>
                        <td>
                            <?php
                                    if($checked['Act14'] == "x"){
            ...
            <br>
            <input hidden name="idCurso" id="idCurso" value="1">
            <center><button type="submit" class="btn btn-primary">Guardar Cambios</button></center>
        </form>
        <br>
        <br>
        <hr width="300px">
        <center><a href="download_file.php?id=java" class="btn btn-primary">Download PDF<i class="material-icons">save_alt</i></a></center>
    </div>
</body>
</html>