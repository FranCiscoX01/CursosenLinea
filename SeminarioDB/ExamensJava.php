...
<head>
    ...
    <title>Examenes Java</title>
</head>
<body>
<?php
        include('Conexion.php');

        $habilitarE = mysqli_query($conexion, "SELECT * FROM RegistroActCurso WHERE idCurso=1 AND Username='".$_SESSION['usuario']."'");
        $ExCalInt = mysqli_query($conexion, "SELECT * FROM Examenes WHERE idCurso=1 AND Username='".$_SESSION['usuario']."'");
    ?>
            ...
            <?php while($b = mysqli_fetch_assoc($ExCalInt)) { ?>
                ...
                <?php
                    if($a['Act1'] == "o" && $a['Act2'] == "o" && $a['Act3'] == "o" && $a['Act4'] == "o" && $a['Act5'] == "o" && $b['CaliUnidadUno'] < 8) {
                        echo "<a href='ExUunoJ.php' class='text-decoration-none'><button type='button' class='btn btn-primary btn-lg btn-block'>Ir a Examen</button></a>";
                    } else {
                ...
                <?php
                    if($a['Act6'] == "o" && $a['Act7'] == "o" && $a['Act8'] == "o" && $a['Act9'] == "o" && $a['Act10'] == "o" && $b['CaliUnidadUno'] >= 8 && $b['CaliUnidadDos'] < 8) {
                        echo "<a href='ExUdosJ.php' class='text-decoration-none'><button type='button' class='btn btn-primary btn-lg btn-block'>Ir a Examen</button></a>";
                    } else {
                ...
                <?php
                    if($a['Act11'] == "o" && $a['Act12'] == "o" && $a['Act13'] == "o" && $a['Act14'] == "o" && $a['Act15'] == "o"  && $b['CaliUnidadDos'] >= 8 && $b['CaliUnidadTres'] < 8) {
                        echo "<a href='ExUtresJ.php' class='text-decoration-none'><button type='button' class='btn btn-primary btn-lg btn-block'>Ir a Examen</button></a>";
                    } else {
