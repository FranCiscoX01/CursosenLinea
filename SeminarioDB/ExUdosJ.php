...
<?php
        ...
        $preguntas11 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=11");
        $respuestas11 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=11 ORDER BY RAND()");
        
        $preguntas12 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=12");
        $respuestas12 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=12 ORDER BY RAND()");

        $preguntas13 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=13");
        $respuestas13 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=13 ORDER BY RAND()");

        $preguntas14 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=14");
        $respuestas14 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=14 ORDER BY RAND()");

        $preguntas15 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=15");
        $respuestas15 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=15 ORDER BY RAND()");

        $preguntas16 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=16");
        $respuestas16 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=16 ORDER BY RAND()");

        $preguntas17 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=17");
        $respuestas17 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=17 ORDER BY RAND()");

        $preguntas18 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=18");
        $respuestas18 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=18 ORDER BY RAND()");

        $preguntas19 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=19");
        $respuestas19 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=19 ORDER BY RAND()");

        $preguntas20 = mysqli_query($conexion, "SELECT * FROM Preguntas WHERE idCurso=1 AND Unidad=2 AND idPregunta=20");
        $respuestas20 = mysqli_query($conexion, "SELECT * FROM Respuestas WHERE idCurso=1 AND Unidad=2 AND idPregunta=20 ORDER BY RAND()");
...
?>
    ...
    <div class="container">
        <form action="CalifEJdos.php" method="POST">
            <p></p>
            <?php
